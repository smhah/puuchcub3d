...
SRC = ft_atoi.c ft_split.c get_next_line.c cast_rays.c check_next_step_x.c check_next_step_y.c cub3d.c cub3d_utils.c file.c horizontal_intersect.c vertical_intersect.c render_walls.c render_sprite.c sprite1.c textures.c update.c walk.c get_next_line_utils.c keypress_keyreleased.c sort_sprite.c screen_shot.c
NAME = cub3D
